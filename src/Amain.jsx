      ...
      <div className='container mt-5'>
        <div className='card p-4 mx-auto' style={{ maxWidth: '400px', backgroundColor: 'rgba(255, 255, 255, 0.8)' }}>
          <div className='text-center'>
            <h1 className='display-4 mb-4'>Dog Details</h1>
            <div className='btn-group-vertical' role='group'>
              <Link to='/admin1' className='btn btn-outline-info mb-2'>View Records</Link>
              <Link to='/view1' className='btn btn-outline-info mb-2'>Payment Report</Link>
