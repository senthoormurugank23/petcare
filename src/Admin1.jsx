...
function Admin1() {
  ...
  const handleDelete = (appointmentId) => {
    axios.delete(`http://localhost:3001/admin1/${appointmentId}`)
      .then(() => {
  ...
  return (
    <div className='container mt-5'>
      <h2 className='text-center mb-4'>Booking Details - Dog Boarding</h2>
      ...
      <table className='table table-bordered'>
       ...
       <a className="btn btn-outline-info mt-3" href="./amain">Back</a>
