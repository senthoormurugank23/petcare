...
function Admin3() {
  ...
  useEffect(() => {
    axios.get('http://localhost:3001/admin3')
      .then(response => setPetDetails(response.data))
      .catch(error => console.error(error));
  }, []);

  const handleDelete = (appointmentId) => {
    axios.delete(`http://localhost:3001/admin3/${appointmentId}`)
      .then(() => {
  ...
  return (
    <div className='container mt-5'>
      <h2 className='text-center mb-4'>Booking Details - Bird Boarding</h2>
